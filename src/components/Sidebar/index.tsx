...
import Logo from '../../images/paymobLogo.png';
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center justify-between gap-2.5 rounded-sm px-4 py-2 font-medium text-cyan-600 duration-300 ease-in-out dark:hover:bg-meta-4 ${
                          (pathname === '/' ||
                            pathname.includes('dashboard')) &&
                          'bg-sky-100 dark:bg-meta-4'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded
                      ...
                      >
                        ...
                        <svg
                          ...
                          //   open && 'rotate-180'
                          // }`}
                          className={`justify-self-end self-center  fill-current ${
                            open && 'rotate-180'
                          }`}
                          width="20"
                          height="20"
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-slate-800 duration-300 ease-in-out hover:text-cyan-900 ' +
              ...
              <li>
                <NavLink
                  to="/profile"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-cyan-600 duration-300 ease-in-out  dark:hover:bg-meta-4 ${
                    pathname.includes('profile') && 'bg-sky-100 dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center justify-between  gap-2.5 rounded-sm py-2 px-4 font-medium text-cyan-600 duration-300 ease-in-out  dark:hover:bg-meta-4 ${
                          (pathname === '/forms' ||
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              ...
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-slate-800 duration-300 ease-in-out hover:text-slate-500 ' +
