...
const SignIn: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark" dir='rtl'>
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <p className="2xl:px-20">
               انضم الينا وسجل الدخول لتتمتع بمزايا عديده
              </p>
